import { parseBandRangeText } from "./parse-band-range";
...
// instead of reusing the parser's enter-at-least-one-band error. Its help text
// is the shared BAND_RANGE_FIELD_SYNTAX_HINT (CT-287) without the empty-field
// clause, since this field requires a value to change the selection.
